...
function handleEscKeyPress(): void {
    let pausedBox: (HTMLElement | null) = document.getElementById("pausedBox");
    let playingAreaScreen: (HTMLElement | null) = document.getElementById("playingAreaScreen");
...
function previewIBar(previewBlocks: Block[]): void {
...
function previewLBlock(previewBlocks: Block[]): void {
    for (let i: number = 0; i < 4; i++) {
        if (previewBlocks[i] !== null && previewBlocks[i].image !== null) {
...
function previewJBlock(previewBlocks: Block[]): void {
    for (let i: number = 0; i < 4; i++) {
        if (previewBlocks[i] !== null && previewBlocks[i].image !== null) {
...
function previewSBlock(previewBlocks: Block[]): void {
    for (let i: number = 0; i < 4; i++) {
        if (previewBlocks[i] !== null && previewBlocks[i].image !== null) {
...
function previewZBlock(previewBlocks: Block[]): void {
    for (let i: number = 0; i < 4; i++) {
        if (previewBlocks[i] !== null && previewBlocks[i].image !== null) {
...
function previewSquareBlock(previewBlocks: Block[]): void {
    for (let i: number = 0; i < 4; i++) {
        if (previewBlocks[i] !== null && previewBlocks[i].image !== null) {
...
function previewTBlock(previewBlocks: Block[]): void {
    for (let i: number = 0; i < 4; i++) {
        if (previewBlocks[i] !== null && previewBlocks[i].image !== null) {
...
function removeLine(y: number): void {
...
function addToPlayingGrid(block: Block): boolean {
...
function removeFromPlayingGrid(x: number, y: number, block: Block) {
    playingGrid[x][y] = null;
...
function addLBlock(blocks: Block[], centerPos: number): boolean {
    for (let i: number = 0; i < 4; i++)
        if (blocks[i] !== null && blocks[i].image !== null)
...
function addJBlock(blocks: Block[], centerPos: number): boolean {
    for (let i: number = 0; i < 4; i++)
...
function addSBlock(blocks: Block[], centerPos: number): boolean {
    for (let i: number = 0; i < 4; i++)
...
function addZBlock(blocks: Block[], centerPos: number): boolean {
    for (let i: number = 0; i < 4; i++)
        if (blocks[i] !== null && blocks[i].image !== null)
...
function addSquareBlock(blocks: Block[], centerPos: number): boolean {
    for (let i: number = 0; i < 4; i++)
        if (blocks[i] !== null && blocks[i].image !== null)
...
function addTBlock(blocks: Block[], centerPos: number): boolean {
    for (let i: number = 0; i < 4; i++)
        if (blocks[i] !== null && blocks[i].image !== null)
...
function addPiece(pieceType: number): Piece {
...
function setPreviewPiece(pieceType: number): void {
...
function doesPieceCollideWithBlocksOnLeft(): boolean {
...
function doesPieceCollideWithBlocksOnRight(): boolean {
...
function didPieceCollideWithBlocksBelow(): boolean {
...
function moveCurrentPieceRight(): void {
...
function moveCurrentPieceLeft(): void {
    // Update internal playing grid array
    for (let i: number = 0; i < 4; i++) {
        removeFromPlayingGrid(currentPiece.blocks[i].x, currentPiece.blocks[i].y, currentPiece.blocks[i]);
...
function moveCurrentPieceDown(): void {
...
function moveCurrentPiece(direction): void {
...
function rotateCurrentPiece(direction: number): void {
